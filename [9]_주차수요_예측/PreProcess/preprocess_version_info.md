...
| LB | 119.2285714286 (-1.8571) |

> Model : Lasso

| 구분 | 성능 점수(MAE) |
| :--: | :-----------: |
| CV | -128.2108916930039 (neg_mae / +1.4496) |
| LB | 111.210051649 (-8.0185)|
...
| 구분 | 성능 점수(MAE) |
| :--: | :-----------: |
| CV | 126.23847596987002 (neg_mae / -1.9724) |
| LB | 110.5499031171 (-0.6602) |
...
| 구분 | 성능 점수(MAE) |
| :--: | :-----------: |
| CV | -126.43471733505991 (neg_mae / +0.1962) |
| LB | 110.9128937328 (+0.3630) |
